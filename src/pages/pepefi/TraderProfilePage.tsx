...
export default function TraderProfilePage() {
  ...
  // Exit loading when contracts unavailable (unsupported network or no address)
  useEffect(() => {
    if (!contracts || !traderAddr) setLoading(false)
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500">
        <Link to="/pepefi/marketplace" className="hover:text-white transition-colors">Marketplace</Link>
        <span>/</span>
