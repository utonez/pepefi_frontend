    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="rounded-card border border-surface-border bg-surface shadow-card p-5 space-y-4">
        ...
        {traderInfo?.isRegistered && eligible === false && (
          <p className="text-xs text-gray-500 text-center -mt-1">
            Stake ≥ 100 mUSDC on the <Link to="/pepefi/stake" className="text-brand-100 hover:underline">Stake page</Link> to unlock publishing.
          </p>
        )}
      </div>
      ...
      <div className="rounded-card border border-surface-border bg-surface shadow-card p-5 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => void fetchEarnings()} className="btn-ghost">
            ↺ Refresh
          </button>
        </div>
