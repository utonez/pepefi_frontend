  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="rounded-card border border-info/20 bg-info/5 p-4 text-xs text-gray-400 space-y-1.5">
        ...
        <div className="pt-2">
          <Link to="/pepefi/marketplace" className="text-info hover:underline">← Back to Marketplace</Link>
          {' · '}
          <Link to="/pepefi/trader" className="text-info hover:underline">Trader Dashboard →</Link>
        </div>
      </div>
